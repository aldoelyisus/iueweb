...
<footer class="footer">
    <div class="contenedor">
        <div class="logo fade-in">
           <a href="{{ route('login') }}"><img src="{{ asset('img/Logo_IUE.png') }}" alt="Instituto Universitario Enlace"></a> 
        </div>
        <p class="side-left">&copy; 2024 Instituto Universitario Enlace. Todos los derechos reservados.</p>
        <p class="side-right"><a href="{{ route('contacto') }}" class="smooth-scroll">Contáctanos</a> | <a href="#privacy_policy" class="smooth-scroll">Política de Privacidad</a></p>
